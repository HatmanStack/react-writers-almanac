export default [
  ...
  '342 It will be Summer -- eventually< h2>',
  '34744',
  '35 10',
  ...
  'After Reading T\x92ao Ch\x92ing, I wander Untethered Through the Short Grass',
  'After Ritsos',
  ...
  'Another Reason Why I Don\x92t Keep a Gun in the House',
  'Another Spring',
  "Anthem for St. Cecilia's Day",
  'Antilamentation',
  'Antimatter',
  "Anton's One-Word Love Letter from the Old Country; Letterfrom Bethesda Home",
  'Ants',
  'Any Morning',
  ...
  'Dharma',
  'Diagnosis',
  'Diagramming Won\x92t Help This Situation',
  ...
  'Exposure',
  'Exterminator',
  'Extrapolations from Henry Manley\x92s Pie Plant',
  ...
  'Fairy Tale',
  'Faith',
  'Faith\x92s Review and Expectation',
  'Fall Song',
  ...
  'Frankie and Albert',
  'Frankie and Johnny',
  'Franklin Hyde, Who caroused in Dirt and was corrected by His Uncle',
  ...
  'Hamburger Heaven',
  'Hamlet\x92s Cat\x92s Soliloquy',
  ...
  'Heyday',
  'He\x92s a Nice Guy, but Always Worrying',
  'Hide-and-Seek 1933',
  'Hiding',
  ...
  'I had thought the tumors...',
  'I have perceiv\x92d that to be with those I like is',
  'I heard a Fly buzz...',
  ...
  'Mrs. Snow',
  'Mrs. Sullivan',
  'Much Ado About Nothing \xa0\xa0\xa0Act II Scene iii',
  'Mud Season',
  'Mud, Apples, Milk',
  'Museum Guard',
  'Musial',
  ...
  'New Year\x92s Resolution',
  'New York Notes',
  'New York Subway',
  'New Yorkers',
  'New-England Boy\x92s Song about Thanksgiving Day',
  ...
  'Open the Blind',
  'Open-Hearted',
  'Opening the Door of a Barn I Thought was Empty on New Year\x92s',
  'Opinion',
  'Opposing Forces',
  'Optimism',
  ...
  'Scary Movies',
  'Scene from a Novel',
  'Schatzie Oster, The Nursing Home Nurse',
  ...
  'The Darkling Thrush',
  'The Daughter of the Farrier; Love and Sleep',
  'The Dawning',
  ...
  'The Psychiatrist Says She\x92s Severely Demented',
  'The Public Garden',
  'The Pulley',
  'The Pupil',
  ...
  'The Thrush\x92s Nest',
  'The Thumb',
  'The Tide Rises, The Tide Falls',
  'The Tide Rises, the Tide Falls',
  'The Titanic',
  'The Tow Truck Driver\x92s Story',
  ...
  'The Village Burglar',
  'The Virtue of Trusting One\x92s Mind',
  'The Visitation',
  'The Waitresses',
  'The Waking',
  ...
  'There\x92s No First Class to Heaven',
  'There\x92s Nothing Like the Sun',
  'These Few Precepts',
